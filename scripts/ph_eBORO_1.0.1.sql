...
-- Project :      EDR_eBORO_v09092025.DM1
--
-- Date Created : Thursday, September 11, 2025 11:00:57
...
CREATE TABLE customer_visit_history(
    waypoint_history_id    int8              NOT NULL,
...
CREATE TABLE role_permissions(
    id_rol_permissions    serial,
    id_user_rol           integer    NOT NULL,
    id_permission         integer    NOT NULL,
    CONSTRAINT pk_id_rol_permissions PRIMARY KEY (id_rol_permissions)
)
;
...
CREATE TABLE roles(
    rol_id         int4            GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
